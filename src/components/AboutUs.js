...
const AboutUs = () => {
  ...
  const partners = [
    ...
    },
    {
      logo: pedro,
      name: 'Pedro',
      details: 'Pedro embodies modern luxury and style with a line of footwear and accessories in a smart twist of timeless classics with international influence for men and women, with emphasis on channeling heightened fashion acumen each season.'
    },
    {
      logo: CharlesandKeith,
      name: 'CHARLES & KEITH',
      details: 'Fashion entrepreneurs, CHARLES & KEITH Wong founded CHARLES & KEITH in 1996 upon identifying the potential of footwear designs catered for Asian women.'
    },
    {
      logo: NIKE,
      name: 'NIKE',
